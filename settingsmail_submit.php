...
$query = $db->query("SELECT * FROM `login_mail` WHERE `mail`= '$email' AND `id_user` <> '{$_COOKIE['id_user']}'");
...
$query = $db->query("UPDATE `post` SET `privat`= '$privat' WHERE `id_user` = '{$_COOKIE['userId']}' ");
