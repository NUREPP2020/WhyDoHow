...
<main class="main-block1">
    <div class="prev"  style="background-image: linear-gradient(rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5)), url('img/девушка1.jpg');" >
        ...
        <div class="maintextp">
            <iframe src="https://www.youtube.com/embed/5qap5aO4i9A" frameborder="1" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
