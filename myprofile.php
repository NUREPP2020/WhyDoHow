...
<main class="main-block">
    ...
    <div class="centerDivs">
        ...
        $sql = "SELECT * FROM `stream` WHERE `id_user`= '{$_COOKIE['userId']}'";
        if($result = mysqli_query($link, $sql)){
            if(mysqli_num_rows($result) > 0){
                while($rows = mysqli_fetch_array($result))
                {
                    echo '<a  href="viewstream.php?id='.$rows['id_stream'].'">';
                    ...
                    echo '</div>';
                    echo '<div class="row post-statistics-values">0</div>';
                    echo '</div>';
        ...
        if($result = mysqli_query($link, $sql)){
            if(mysqli_num_rows($result) > 0){
                while($rows = mysqli_fetch_array($result))
                {
                    ...
                    echo '<img src="img/heart.png" alt="" class="post-statistics-image">';
                    echo '</div>';
                    echo '<div class="row post-statistics-values">'.$rows['like_count'].'</div>';
                    echo '</div>';
                    echo '<div class="col post-statistics-comment" style="">';
                    echo '<div class="row" style="padding: 0">';
                    echo '<img src="img/comment.png" alt="" class="post-statistics-image">';
                    echo '</div>';
                    echo '<div class="row post-statistics-values">'.$r['CountCom'].'</div>';
                    echo '</div>';
                    echo '<div class="col post-statistics-views" style="">';
                    echo '<div class="row" style="padding: 0">';
                    echo '<img src="img/eye.png" alt="" class="post-statistics-image">';
